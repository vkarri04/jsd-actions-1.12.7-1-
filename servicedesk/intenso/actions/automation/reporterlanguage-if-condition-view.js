define("servicedesk/intenso/actions/automation/reporterlanguage-if-condition-view", [],
function () {
    ...
    return Brace.View.extend({
        template: JSDActions.Templates.Automation.Modules.RuleIf.ReporterLanguage.setReporterLanguageForm,
        mixins: [FormMixin],
