define("servicedesk/intenso/actions/automation/addorganizationtoissue-then-action-view", [],
function () {
    ...
    return Brace.View.extend({
        template: JSDActions.Templates.Automation.Modules.RuleThen.AddOrganizations.addOrganizationsThenActionForm,
        mixins: [FormMixin],
