define("servicedesk/intenso/actions/automation/add-label-then-action-view", [],
function () {
    ...
    return Brace.View.extend({
        template: JSDActions.Templates.Automation.Modules.RuleThen.AddLabel.drawIssueLabelForm,
        mixins: [FormMixin],
