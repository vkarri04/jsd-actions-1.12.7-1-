define("servicedesk/intenso/actions/automation/addrequestparticipants-then-action-view", [],
function () {
    ...
    return Brace.View.extend({
        template: JSDActions.Templates.Automation.Modules.RuleThen.AddRequestParticipants.addRequestParticipantsThenActionForm,
        mixins: [FormMixin],
