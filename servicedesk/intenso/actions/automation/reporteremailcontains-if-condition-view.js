define("servicedesk/intenso/actions/automation/reporteremailcontains-if-condition-view", [],
function () {
    ...
    return Brace.View.extend({
        template: JSDActions.Templates.Automation.Modules.RuleIf.ReporterEmailContains.drawReporterEmailContainsForm,
        mixins: [FormMixin],
