define("servicedesk/intenso/actions/automation/setpriority-then-action-view", [],
function () {
    ...
    return Brace.View.extend({
        template: JSDActions.Templates.Automation.Modules.RuleThen.SetPriority.setPriorityForm,
        mixins: [FormMixin],
